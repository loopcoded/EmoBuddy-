...
export default function Level3Journey({ childID, onProgressClick, initialProgress , onProgressUpdated}: Level3JourneyProps = {}) {
  ...
  if (currentGame) {
    ...
    return (
      <div
        ...
        style={{
          backgroundImage: `url('https://hebbkx1anhila5yf.public.blob.vercel-storage.com/level3-ewDYfbxPRb6V50hinnxpxpImfMB2xr.jpg')`,
          backgroundSize: "140%",
        ...
        progress.game6Completed && (
          ...
          >
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-orange-400 to-red-500 rounded-3xl p-8 shadow-2xl inline-block hover:shadow-3xl transition-all cursor-pointer"
            >
              <p className="text-4xl font-bold text-white drop-shadow-lg">
                🎉 Level Complete! 🎉
              </p>
              <p className="text-xl text-white mt-2 drop-shadow-lg">
                Click to see your rewards
              </p>
            </motion.button>
          </motion.div>
        )}
